...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    if (id.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Por favor, insira o ID do produto.", "Erro", JOptionPane.ERROR_MESSAGE);
        return; // Impede a execução se o ID estiver vazio
    }
    ...
    try {
        ...
        JOptionPane.showMessageDialog(this, "ID do produto inválido. Insira um número inteiro.", "Erro", JOptionPane.ERROR_MESSAGE);
    }
